...
# Filter: Nur Jahre 2016 bis 2026
df = df[df["Jahr-Monat"].str[:4].astype(int).between(2016, 2026)] #anpassen wenn neue Daten vorliegen
...
# Nur Zeiträume ab 2019 bis einschließlich 2026-Q2 # Zeiträume anpassen
default_zeitraeume = [
    z for z in zeitraeume
    if (
        (2019 <= int(z[:4]) < 2026)  # Jahre 2019 bis 2025 
        or (z in ['2026-Q1', '2026-Q2']) #, '2026-Q3', '2026-Q4'])  # Explizit Q1, Q2, Q3, Q4 von 2026 werden zusätzlich zugelassen
    )
]
